...
- Used a **MySQL database** to store accuracy metrics, timestamps, and performance insights.  
- Achieved **82% accuracy** in query-response validation and a **12% reduction in response time**.  
- Planned integration with **BERT/GPT embeddings** for enhanced contextual understanding and **cloud scalability**.  
...
🧠 **Pitch Deck Analyzer**  
- Performs detailed analysis of uploaded pitch decks.  
- Provides **comparative analysis**, **sentiment evaluation**, and **Named Entity Recognition (NER)**.  
- Conducts **slide-by-slide review** with AI-generated feedback and scoring.  
- Utilizes pretrained models from **Hugging Face** and **Gemini 2.5 Flash** for accurate and context-aware results.  

💼 **Investor & Accelerator Recommendations**  
- Enter your **startup description**, **funding stage**, and **investor type** to receive personalized recommendations.  
- Access a curated database of **3000+ verified investors and accelerators**, complete with **web links** and **focus areas**.  

📈 **Success Prediction Engine**  
- Predicts **startup success probability** using **Logistic Regression models**.  
- Explains predictions through **SHAP (SHapley Additive exPlanations)** for interpretability and transparency.  

🔍 **7-Domain AI Analysis & RAG-Based Chatbot**  
FoundersFuel performs deep evaluation across seven critical domains using a **Retrieval-Augmented Generation (RAG)** pipeline enhanced with **SerpAPI** for real-time web insights.  

**The 7 Analysis Domains Include:**  
1. **Startup Idea Evaluation** – Assess innovation and problem-solution fit.  
2. **Uniqueness & Market Differentiation** – Identify competitive edge.  
3. **Technology Stack & Architecture** – Review tech robustness and scalability.  
4. **Similar Startups & Competition** – Analyze existing market players.  
5. **Pitch Generation** – Generate AI-assisted pitch improvements.  
6. **Improvement Suggestions** – Receive targeted advice for growth.  
7. **Investment Metrics & Strategic Insights** – Evaluate funding readiness and investor appeal.  
...
**Objective:**  
Developed an **AI-driven system** to predict **city-level PM2.5 and PM10 concentrations** by integrating satellite, sensor, and meteorological data.

**How It Works:**  
1. **Data Fusion:** Combines **Satellite AOD (INSAT-3D)**, **CPCB ground sensor**, and **MERRA-2 weather data**.  
2. **AI Model:** Uses **XGBoost** to predict PM levels with **<5µg/m³ MAE**, validated against ground truth data.  
3. **Visualization:** Provides **interactive dashboards and maps** for real-time AQI and PM monitoring.  

**Impact:**  
Supports **air pollution research**, **policy decisions**, and **public health awareness** using data-driven insights.  
**Tech:** Python, XGBoost, Pandas, NumPy, Plotly, GeoPandas  
...
| 🤖 **Machine Learning** | ![XGBoost](https://img.shields.io/badge/XGBoost-EB5E28?style=for-the-badge&logoColor=white) ![LightGBM](https://img.shields.io/badge/LightGBM-017E7E?style=for-the-badge&logoColor=white) ![CatBoost](https://img.shields.io/badge/CatBoost-FF6F00?style=for-the-badge&logoColor=white) ![Random Forest](https://img.shields.io/badge/Random%20Forest-228B22?style=for-the-badge&logoColor=white) ![KNN](https://img.shields.io/badge/KNN-4285F4?style=for-the-badge&logoColor=white) ![ARIMA](https://img.shields.io/badge/ARIMA-336699?style=for-the-badge&logoColor=white) ![Time Series](https://img.shields.io/badge/Time%20Series-3B82F6?style=for-the-badge&logoColor=white) |
| 🧠 **Artificial Intelligence** | ![NLP](https://img.shields.io/badge/NLP-8E44AD?style=for-the-badge&logoColor=white) ![OCR](https://img.shields.io/badge/OCR-5C2D91?style=for-the-badge&logoColor=white) ![YOLOv8](https://img.shields.io/badge/YOLOv8-FF0000?style=for-the-badge&logoColor=white) ![RAG](https://img.shields.io/badge/RAG-1E90FF?style=for-the-badge&logoColor=white) ![Generative AI](https://img.shields.io/badge/Generative%20AI-FF69B4?style=for-the-badge&logoColor=white) ![Pretrained Models](https://img.shields.io/badge/Pretrained%20Models-BF40BF?style=for-the-badge&logoColor=white) ![Explainability (SHAP)](https://img.shields.io/badge/Explainability%20(SHAP)-6A1B9A?style=for-the-badge&logoColor=white) |
...
- 👩🏻‍💻 **GirlScript Summer of Code** - Completed 6 merged PRs (3 × Level 3, 2 × Level 2, 1 × Level 1) across 6 open-source projects.  
